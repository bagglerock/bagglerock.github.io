import { shouldEnhance } from "../core/experience-policy.js";
...
export function initExperienceMode() {
  ...
  let choice = "auto";
  try {
    choice = localStorage.getItem("portfolio-view") || "auto";
  } catch {}
  ...
  function update() {
    ...
    button.setAttribute(
      "aria-label",
      mode.enabled
        ? "Switch to the simple page layout"
        : "Switch to the enhanced page layout",
    );
  ...
  button.addEventListener("click", () => {
    ...
    try {
      localStorage.setItem("portfolio-view", choice);
    } catch {}
    update();
  });
